    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">Selamat datang kembali! Apa yang ingin Anda kerjakan hari ini?</p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-blue-200">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-neutral-900">Mulai Pengerjaan</h3>
                ...
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-neutral-900">Total Terverifikasi</h3>
